...
int main()
{
  ...
  // LinkedList<int>::Node *head = merged.getHeadPtr();
  // LinkedList<int>::Node *tail = merged.getTailPtr();
  // std::cout << "head prev: " << head->prev << std::endl;
  // std::cout << "head : " << head->data << std::endl;
  // std::cout << "head next: " << head->next->data << std::endl;
  // std::cout << "tail prev: " << tail->prev->data << std::endl;
...
void informalTests()
{
...

  {
    ...
    if (expectedBackHalf != halves.back())
      errorReaction("back half is wrong");
  }
  ...
  {
    std::cout << std::endl
              << "Testing insertOrdered:" << std::endl;
...

  {
    ...
    if (l2 == expected && !l2.isSorted())
      errorReaction("Bug in isSorted");
  }
  ...
  {
    std::cout << std::endl
              << "Testing mergeSortRecursive:" << std::endl;
    LinkedList<int> l;
    l.pushBack(10);
    l.pushBack(4);
    l.pushBack(7);
  ...
  {
    std::cout << std::endl
              << "Testing mergeSortIterative:" << std::endl;
    LinkedList<int> l;
    l.pushBack(10);
    l.pushBack(4);
    l.pushBack(-1);
