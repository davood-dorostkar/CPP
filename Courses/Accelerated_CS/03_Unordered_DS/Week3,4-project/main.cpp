...
void informalTests()
{
  ...
  if (showWelcome)
  {
    std::cout << makeHeader1("Welcome") << std::endl
              << std::endl;
    std::cout
  ...
  {
    std::cout << makeHeader2("Skipping welcome message.") << std::endl
              << std::endl;
  }
  ...
  {
    std::cout << makeHeader1("Demonstrations") << std::endl
              << std::endl;
    demoRunner();
  }
  else
  {
    std::cout << makeHeader2("Skipping demonstrations.") << std::endl
              << std::endl;
    std::cout << "  (Please do try the demonstrations and look at the instructions PDF.)" << std::endl
              << std::endl;
  }
  ...
  if (doEx1Tests)
  {
    std::cout << makeHeader1("Exercise 1 informal tests") << std::endl
              << std::endl;
    countEdgesTester();
    removeEdgeTester();
    removePointTester();
  ...
  {
    std::cout << makeHeader2("Skipping informal tests for Exercise 1.") << std::endl
              << std::endl;
  }
  ...
  if (doEx2Tests)
  {
    std::cout << makeHeader1("Exercise 2 informal tests") << std::endl
              << std::endl;
  ...
  {
    std::cout << makeHeader2("Skipping informal tests for Exercise 2.") << std::endl
              << std::endl;
  }
  ...
  if (doEx3Tests)
  {
    std::cout << makeHeader1("Exercise 3 informal tests") << std::endl
              << std::endl;
    ...
    if (!doEx3SlowTests)
      std::cout << "(informalTests: doEx3SlowTests==false, so we'll skip some slow tests.)" << std::endl
                << std::endl;

    if (doEx3SlowTests)
      puzzleBFS_Tester_NoPath(); // This one is slow even when your code is correct!
  ...
  {
    std::cout << makeHeader2("Skipping informal tests for Exercise 3.") << std::endl
              << std::endl;
  }
...
void demoRunner()
{
  ...
  {
    std::cout << makeHeader2("Using std::unordered_set") << std::endl
              << std::endl;
    ...
    std::cout << "Then we can insert some items with insert():" << std::endl
              << std::endl;
  ...
  {
    std::cout << makeHeader2("Undirected edge representation with IntPairPair") << std::endl
              << std::endl;
    ...
    std::cout << "Our GridGraph class doesn't explicitly store edges since it uses an adjacency" << std::endl
              ...
              << "edges in order to display terminal output." << std::endl
              << std::endl;
    ...
    std::cout << "This is where we have to be careful, because IntPairPair is just a pair of" << std::endl
              ...
              << "for an undrected edge representation." << std::endl
              << std::endl;
    ...
    std::cout << "If you wanted to extend the code further, you could make a derived class" << std::endl
              ...
              << "such as in GridGraph::printDetails." << std::endl
              << std::endl;
  }

  {
    std::cout << makeHeader2("Various ways to initialize objects") << std::endl
              << std::endl;
...
void removeEdgeTester()
{
  ...
  {
    std::cout << makeHeader2("Testing GridGraph::removeEdge") << std::endl
              << std::endl;

    std::cout << "(Note: This function was probably implemented for you already.)" << std::endl
              << std::endl;

    std::cout << "        Here's a graph:" << std::endl
              << std::endl;
    ;
    GridGraph graph1;
    ...
    {
      std::cout << "Good, the edge was removed correctly." << std::endl
                << std::endl;
    }
    else
    {
...
void removePointTester()
{
  ...
  std::cout << makeHeader2("Testing your removePoint function") << std::endl
            << std::endl;
  ...
  std::cout << "    Here's the first graph again:" << std::endl
            << std::endl;
  ;
  ...
  std::cout << "        Removing point (2,2):" << std::endl
            << std::endl;
  ;
  ...
  {
    std::cout << "Good, the point (2,2) was removed." << std::endl
              << std::endl;
  }
  ...
  {
    std::cout << "Good, it looks like the point removal worked correctly." << std::endl
              << std::endl;
  }
  else
  {
  ...
  std::cout << "Now trying to remove a non-existent point (7,7)..." << std::endl
            << "The graph should be unchanged and the program shouldn't crash." << std::endl
            << std::endl;
  ...
  {
    std::cout << "Good, the graph was unchanged by that operation." << std::endl
              << std::endl;
  }
}
...
void countEdgesTester()
{
  ...
  std::cout << makeHeader2("Testing your countEdges function") << std::endl
            << std::endl;
  ...
  std::cout << "Here's an \"I\"-shaped graph:" << std::endl
            << std::endl;
  graph.plot(std::cout);
  std::cout << std::endl;
  graph.printDetails(std::cout);
  ...
  std::cout << "You counted: " << numEdges << " edges" << std::endl
            << std::endl;

  if (numEdges == 7)
  {
    std::cout << "Good! You counted the right number of edges." << std::endl
              << std::endl;
  }
  else
  {
...
void graphBFS_Tester()
{
  ...
  std::cout << makeHeader2("Testing graphBFS (when a path does exist)") << std::endl
            << std::endl;
  ...
  std::cout << "Finding the shortest path from (0,0) to (6,5):" << std::endl
            << std::endl;
  ...
  else
  {
    ...
    if (!GridGraph::allowVerboseTextDescription && !forceDescribePath)
    {
      std::cout << "Omitting verbose text description of path. You can change this in main.cpp" << std::endl
                << " in the graphBFS_Tester function definition." << std::endl
                << std::endl;
    }
    ...
    if (allGood)
      std::cout << "Good! You found the shortest path to the goal." << std::endl;
    else
      std::cout << "Some warnings or errors occurred in this test." << std::endl;
  }
...
void graphBFS_Tester_NoPath()
{
  ...
  std::cout << makeHeader2("Testing graphBFS (when there is no path)") << std::endl
            << std::endl;

  std::cout << "In this maze there's no way to reach the goal from the start,\n"
            << "so your graphBFS should return an empty list:" << std::endl
            << std::endl;
  ...
  else
  {
    std::cout << "Error: Your graphBFS returned some path when none should exist.\n"
              << "Here is the path that your graphBFS returned:" << std::endl
              << std::endl;
...
void graphBFS_Tester_StartAtGoal()
{
  ...
  std::cout << makeHeader2("Testing graphBFS (when start==goal)") << std::endl
            << std::endl;

  std::cout << "Testing the edge case where we start at the goal.\nHere's a simple graph:" << std::endl
            << std::endl;
  ...
  std::cout << "Finding the shortest path from (0,0) to (0,0):" << std::endl
            << std::endl;
  const auto maze_start = IntPair(0, 0);
  ...
  else
  {
    std::cout << "Here is the path that your graphBFS returned:" << std::endl
              << "(It should be a single point (0,0), in this case.)" << std::endl
              << std::endl;
    ...
    if (allGood)
      std::cout << "Good! When start==goal, the shortest path is to stay at the start." << std::endl;
    else
      std::cout << "Some warnings or errors occurred in this test." << std::endl;
  }
...
void puzzleBFS_Tester()
{
  ...
  std::cout << makeHeader2("Testing puzzleBFS (simple puzzle instance)") << std::endl
            << std::endl;

  std::cout << "This puzzle can be solved from the given starting position, so puzzleBFS" << std::endl
            << "should be able to solve it and find the shortest solution too." << std::endl
            << std::endl;
  ...
  std::cout << "Finding the shortest solution sequence:" << std::endl
            << std::endl;
  ...
  else
  {
    ...
    std::cout << "Returned some path (list of sequential states). Validating..." << std::endl
              << std::endl;
    ...
    if (allGood)
      std::cout << "Good! You found the shortest solution sequence." << std::endl;
    else
      std::cout << "Some warnings or errors occurred in this test." << std::endl;
  }
...
void puzzleBFS_Tester_NoPath()
{
  ...
  std::cout << makeHeader2("Testing puzzleBFS (when there is no solution)") << std::endl
            << std::endl;
  ...
  else
  {
    std::cout << "Error: Your puzzleBFS returned some path when none should exist.\n"
              << "Here is the path that your puzzleBFS returned:" << std::endl
              << std::endl;
...
void puzzleBFS_Tester_StartAtGoal()
{
  ...
  std::cout << makeHeader2("Testing puzzleBFS (when start==goal)") << std::endl
            << std::endl;

  std::cout << "Testing the edge case where we start at the goal." << std::endl
            << std::endl;
...
void puzzleBFS_Tester_Random()
{
  ...
  std::cout << makeHeader2("Testing puzzleBFS with a random, solvable puzzle") << std::endl
            << std::endl;
